...
app.post('/getTransaction',(req,res) => {
	...
	.then(result =>{
		result.fees = web3.utils.fromWei(String(result.gas * result.gasPrice));
		result.value = web3.utils.fromWei(result.value);
		result.gas = web3.utils.fromWei(String(result.gas));
		result.gasPrice = web3.utils.fromWei(String(result.gasPrice));
